...
# HOMUS contains images of 40 x 40 pixels input image dimensions for train
...
def load_data
    # Load data from data/HOMUS/train_0, data/HOMUS/train_1,...,data/HOMUS_31 folders from HOMUS
    image_list = []
    class_list = []
...
###########################################################
# Main program the data split between train and test sets #
###########################################################
